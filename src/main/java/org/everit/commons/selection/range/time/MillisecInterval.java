...
public class MillisecInterval extends Interval<Long> {

    private static final long serialVersionUID = 3310232471225175141L;

    public MillisecInterval(final Long lowerBound, final Long higherBound) {
        super(lowerBound, higherBound);
    }

    public MillisecInterval(final Long lowerBound, final Long higherBound, final boolean lowerInclusive,

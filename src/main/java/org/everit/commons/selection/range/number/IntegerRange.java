...
public class IntegerRange extends NumberRange<Integer> {
    ...
    private static final long serialVersionUID = -8663176845069854427L;

    public IntegerRange(final Integer lowerBound, final Integer higherBound) {
        super(lowerBound, higherBound);
    }

    public IntegerRange(final Integer lowerBound, final Integer higherBound, final boolean lowerInclusive,
    ...
    public Integer getLength() {
        return higherBound.intValue() - lowerBound.intValue();
    }

...
public class DateInterval extends Interval<Date> {
    ...
    public DateInterval(final Date lowerBound, final Date higherBound) {
        super(lowerBound, higherBound);
    }

    public DateInterval(final Date lowerBound, final Date higherBound, final boolean lowerInclusive,

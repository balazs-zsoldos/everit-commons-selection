...
public class FloatRange extends NumberRange<Float> {
    ...
    private static final long serialVersionUID = 6431484139891675642L;

    public FloatRange(final Float lowerBound, final Float higherBound) {
        super(lowerBound, higherBound);
    }

    public FloatRange(final Float lowerBound, final Float higherBound, final boolean lowerInclusive,
    ...
    public Float getLength() {
        return higherBound.floatValue() - lowerBound.floatValue();
    }
